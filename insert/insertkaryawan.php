                    ...
                    <div class="d-flex align-items-center">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb m-0 p-0">
                                ...
                                <li class="breadcrumb-item text-muted active" aria-current="page">Insert Karyawan</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <input type="text" name="namakaryawan" class="form-control" placeholder="nama">
                                </div>
                            </div>
                            <div class="card-body">
                                <h6 class="card-title"> Alamat : </h6>
                                <div class="form-group">
                                    <input type="text" name="keterangan" class="form-control" placeholder="alamat">
                                </div>
                            </div>
                            <div class="card-body">
                                <h6 class="card-title"> Telepon : </h6>
                                <div class="form-group">
                                    <input type="text" name="telp" class="form-control" placeholder="keterangan">
                                </div>
                            </div>
                            <div class="card-body">
                                <center>
