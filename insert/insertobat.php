            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h6 class="page-title text-truncate text-dark font-weight-medium mb-1">Form Insert</h6>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="index.html" class="text-muted">Home</a></li>
                                    <li class="breadcrumb-item text-muted active" aria-current="page">Insert Obat</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                            ...
                            <div class="card">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <select class="custom-select" name="idsupplier">
                                                ...
                                                while ($row = mysqli_fetch_assoc($hasil)) { ?>
                                                    <option value="<?= $row['idsupplier'] ?>"><?= $row['idsupplier'] . ' - ' . $row['perusahaan'] ?>
                                                    </option>
                                                <?php }
                                                ?>
                                            </select>
                                ...
                                <div class="card-body">
                                    <h6 class="card-title"> Nama Obat : </h6>
                                        <div class="form-group">
                                            <input type="text" name="namaobat" class="form-control" placeholder="nama">
                                        </div>
                                </div>
                                <div class="card-body">
                                    <h6 class="card-title"> Kategori Obat : </h6>
                                        <div class="form-group">
                                            <input type="text" name="kategoriobat" class="form-control" placeholder="jenis">
                                        </div>
                                </div>
                                <div class="card-body">
                                ...
                                <div class="card-body">
                                    <h6 class="card-title"> Stok Obat : </h6>
                                        <div class="form-group">
                                            <input type="text" name="stokobat" class="form-control" placeholder="Stok Obat">
                                        </div>
                                </div>
                                <div class="card-body">
