                    ...
                    <div class="d-flex align-items-center">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb m-0 p-0">
                                ...
                                <li class="breadcrumb-item text-muted active" aria-current="page">Table Supplier</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                ...
                <div class="col-12">
                    <div class="card">
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    while ($row = mysqli_fetch_assoc($hasil)) {
                                        ...
                                        echo "<td class='w-50'>" . $row['keterangan']     . "</td>";
                                        echo "<td>
                                                    <a class ='btn btn icon-trash' 
                                                    data-toggle='tooltip' 
                                                    data-placement='top' 
                                                    title='Delete' 
                                                    href='../delete/deletesupplier.php?idsupplier=" . $row['idsupplier'] . "'></a>

                                                    <a class ='btn icon-wrench' 
                                                    data-toggle='tooltip' 
                                                    data-placement='top' 
                                                    title='Update' 
                                                    href='../update/updatesupplier.php?idsupplier=" . $row['idsupplier'] . "'></a>
                        ...
                        <div class="card-body print-data">
                            <a href="../insert/insertsupplier.php" class="btn btn-primary btn-rounded float-right">Insert Data</a>
