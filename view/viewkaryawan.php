                    ...
                    <div class="d-flex align-items-center">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb m-0 p-0">
                                ...
                                <li class="breadcrumb-item text-muted active" aria-current="page">Table Karyawan</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                ...
                <div class="col-12">
                    <div class="card">
                                ...
                                <tbody>
                                    ...
                                    while ($row = mysqli_fetch_assoc($hasil)) {
                                        ...
                                        echo "<td>
                                                        ...
                                                        title='Delete'
                                                        href='../delete/deletekaryawan.php?idkaryawan=" . $row['idkaryawan'] . "'></a>

                                                        <a class ='btn icon-wrench' data-toggle='tooltip' data-placement='top' 
                                                        title='Update' 
                                                        href='../update/updatekaryawan.php?idkaryawan=" . $row['idkaryawan'] . "'></a>
                                                    </td>";
                                        echo "</tr>";
                                    }
                                    ?>
                        ...
                        <div class="card-body print-data">
                            <a href="../insert/insertkaryawan.php" class="btn btn-primary btn-rounded float-right">Insert Data</a>
