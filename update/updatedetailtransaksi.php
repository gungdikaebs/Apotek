                        ...
                        <div class="col-md-10 m-auto">
                            <div class="card">
                                ...
                                <div class="card-body" hidden>
                                    <h6 class="card-title"> Id Detail Transaksi : </h6>
                                        <div class="form-group">
                                            <input type="text" name="iddetailtransaksi" class="form-control" value="<?= $data ['iddetailtransaksi']; ?>">
                                        </div>
                                </div>
                                <div class="card-body">
                                    <h6 class="card-title"> Id Transaksi : </h6>
                                        <div class="form-group">
                                ...
                                <div class="card-body">
                                    <h6 class="card-title"> Id Obat : </h6>
                                        <div class="form-group">
                                            <input type="text" name="idobat" class="form-control" value="<?= $data ['idobat']; ?>">
                                        </div>
                                </div>
                                <div class="card-body">
                                ...
                                <div class="card-body">
                                    <h6 class="card-title"> Harga Satuan : </h6>
                                        <div class="form-group">
                                            <input type="text" name="hargasatuan" class="form-control" value="<?= $data ['hargasatuan']; ?>">
                                        </div>
                                </div>
                                <div class="card-body">
                                    <h6 class="card-title"> Total Harga : </h6>
                                        <div class="form-group">
                                            <input type="text" name="totalharga" class="form-control" value="<?= $data ['totalharga']; ?>">
                                        </div>
                                </div>
                                <div class="card-body">
                                    <center>
