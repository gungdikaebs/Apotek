                    ...
                    <div class="d-flex align-items-center">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb m-0 p-0">
                                ...
                                <li class="breadcrumb-item text-muted active" aria-current="page">Update Karyawan</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                        ...
                        <div class="col-md-10 m-auto">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="namakaryawan" class="form-control" value="<?= $data['namakaryawan']; ?>">
                                    </div>
                                </div>
                                <div class="card-body">
