                    ...
                    <div class="d-flex align-items-center">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb m-0 p-0">
                                ...
                                <li class="breadcrumb-item text-muted active" aria-current="page">Update Pelanggan</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                        ...
                        <div class="col-md-10 m-auto">
                            <div class="card">
                                ...
                                <div class="card-body" hidden>
                                    <h6 class="card-title"> idpelanggan : </h6>
                                    <div class="form-group">
                                        <input type="text" name="idpelanggan" class="form-control" value="<?= $data['idpelanggan']; ?>">
                                    </div>
                                </div>
                                <div class="card-body">
                                    <h6 class="card-title"> Nama Lengkap : </h6>
                                    <div class="form-group">
                                        <input type="text" name="namalengkap" class="form-control" value="<?= $data['namalengkap']; ?>">
                                    </div>
                                </div>
                                <div class="card-body">
                                ...
                                <div class="card-body col-md-10">
                                    <h6 class="card-title"> Bukti Foto Resep : </h6>
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text">Upload</span>
                                        </div>
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input" name="buktifotoresep">
                                            <label class="custom-file-label">Choose file</label>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <img class="col col-lg-4" src="../simpanfoto/<?= $data['buktifotoresep']; ?>">
                                    </div>
                                </div>
                                <div class="card-body">
                                    <center>
